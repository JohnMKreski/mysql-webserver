...
exports.getMe = async (req, res) => {
  // verify valid token
  const decoded = req.user; // set upin middleware {id: 1, iat: wlenfwekl, expiredIn: 9174323 }
...
exports.updateMe = async function (req, res) {
  ...
  if (!passwordUnchanged) {
    const passwordHash = bcrypt.hashSync(req.body.password); //encrypting new password
